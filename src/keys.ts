...
export function accountGlvDepositListKey(account: any) {
  return hashData(["bytes32", "address"], [ACCOUNT_GLV_DEPOSIT_LIST, account]);
}

export function accountGlvWithdrawalListKey(account: any) {
